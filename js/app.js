(() => {
    ...
    document.addEventListener("click", (function(e) {
        if (e.target.closest(".header__burger")) {
            ...
            rootElement.classList.toggle("lock");
        }
    }));
    window.addEventListener("scroll", (function(e) {
        const headerElement = document.querySelector(".header");
        headerElement.offsetHeight;
        if (scrollY) headerElement.classList.add("header_scroll"); else headerElement.classList.remove("header_scroll");
    }));
    const mainForm = document.forms.mainForm;
    const mainInput = mainForm.mainInput;
    mainForm.addEventListener("submit", (function(event) {
        if (emailTest(mainInput)) {
            mainInput.classList.add("_form-error");
    ...
    mainForm.addEventListener("focusout", (function(event) {
        mainInput.classList.remove("_form-error");
    }));
    ...
    mainFormTwo.addEventListener("submit", (function(event) {
        if (emailTest(mainInputTwo)) {
            mainInputTwo.classList.add("_form-error");
            event.preventDefault();
        }
    }));
    mainFormTwo.addEventListener("focusout", (function(event) {
        mainInputTwo.classList.remove("_form-error");
    }));
